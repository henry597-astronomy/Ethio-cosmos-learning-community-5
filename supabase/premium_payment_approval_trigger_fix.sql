-- Corrective migration: payment_submission_id belongs to premium_entitlements,
-- not premium_payment_submissions. Keep the original submission protections intact.

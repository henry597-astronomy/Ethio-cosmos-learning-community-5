...
function AppRoutes() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0e1a] flex flex-col" style={{ overflowY: 'auto', WebkitOverflowScrolling: 'touch' }}>
      <Navbar />
      <InstallPrompt />
      <main className="flex-1 pt-28" style={{ overflowY: 'auto', WebkitOverflowScrolling: 'touch', paddingBottom: 'calc(3rem + max(0px, env(safe-area-inset-bottom)))' }}>
        <Routes>

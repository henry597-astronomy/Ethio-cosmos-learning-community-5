...
const APK_RELEASE_URL =
  'https://github.com/henry597-astronomy/Ethio-cosmos-learning-community-5/releases/download/v1.10.4/ethiocosmos-v1.10.4.apk';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (!upstreamRes.ok || !upstreamRes.body) {
      ...
      res.setHeader('Content-Disposition', 'attachment; filename="ethiocosmos-v1.10.4.apk"');
      res.statusCode = 302;
